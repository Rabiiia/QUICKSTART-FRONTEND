export const DROPLET_FOLDER = "/XXX" // <-- replace with your folder that your create on droplet. 
                                             //This droplet folder path will play huge role whenever you use Route or/and Link components, 
                                             //not necessary in all of them. it depends on how you design frontend 
